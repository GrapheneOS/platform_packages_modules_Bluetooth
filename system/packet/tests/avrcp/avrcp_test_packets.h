...
std::vector<uint8_t> list_player_application_setting_attributes_response = {
    0x0c, 0x48, 0x00, 0x00, 0x19, 0x58, 0x11,
    0x00, 0x00, 0x03, 0x02, 0x02, 0x03};
...
std::vector<uint8_t> list_player_application_setting_attribute_values_response =
    {0x0c, 0x48, 0x00, 0x00, 0x19, 0x58, 0x12, 0x00,
     0x00, 0x05, 0x04, 0x01, 0x02, 0x03, 0x04};
...
std::vector<uint8_t> get_current_player_application_setting_value_request = {
    0x01, 0x48, 0x00, 0x00, 0x19, 0x58, 0x13,
    0x00, 0x00, 0x03, 0x02, 0x02, 0x03};
...
std::vector<uint8_t>
    invalid_setting_set_player_application_setting_value_request = {
        0x00, 0x48, 0x00, 0x00, 0x19, 0x58, 0x14, 0x00,
        0x00, 0x05, 0x02, 0x02, 0x01, 0x7f, 0x01};
...
std::vector<uint8_t>
    invalid_value_set_player_application_setting_value_request = {
        0x00, 0x48, 0x00, 0x00, 0x19, 0x58, 0x14, 0x00,
        0x00, 0x05, 0x02, 0x02, 0x01, 0x03, 0x7f};
...
std::vector<uint8_t> set_player_application_setting_value_response = {
    0x09, 0x48, 0x00, 0x00, 0x19, 0x58, 0x14, 0x00, 0x00, 0x00};
...
std::vector<uint8_t> changed_player_setting_notification = {
    0x0d, 0x48, 0x00, 0x00, 0x19, 0x58, 0x31, 0x00,
    0x00, 0x06, 0x08, 0x02, 0x02, 0x01, 0x03, 0x02};
