...
/**
 * Media Control Profile service interface
 */
public interface McpService {
    ...
    void setMediaControlRequestResult(McpServiceMediaControlRequest request,
            McpServiceMediaControlRequest.Results resultStatus);
    void setSearchRequestResult(McpServiceSearchRequest request,
