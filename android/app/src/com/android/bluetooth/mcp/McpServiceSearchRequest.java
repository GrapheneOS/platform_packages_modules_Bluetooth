...
/**
 * Media Control Profile search request
 */
public final class McpServiceSearchRequest {
    private int mType;
     ...
     */
    public McpServiceSearchRequest(int type, String arg) {
        this.mType = type;
        this.mStringArg = arg;
    }
     ...
     */
    public @NonNull String getStringArg() { return mStringArg; };
}
